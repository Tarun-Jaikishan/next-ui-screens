...
export default function Hero() {
  return (
    ...
    >
      {/* Intro Section */}
      <div className="text-center px-10 lg:px-24 pt-20 w-full h-40 md:h-56">
        <ReactTyped
          strings={[
      ...
      <MyReveal keyframes={MyAnimations.fadeUp} triggerOnce>
        <p className="text-white text-center mt-10 lg:mt-1 px-10 lg:px-24">
      ...
      <div className="mt-10 md:flex md:justify-center md:gap-32 md:items-start">
        {/* Trusted Client Section */}
        <MyReveal keyframes={MyAnimations.fadeRight} triggerOnce>
          <div className="flex justify-center mt-10 md:mt-0">
            <div>
              <p className="text-white font-semibold">5m+ Trusted Clients</p>
